/*
  ...
  - You are about to drop the column `emailupdates` on the `UserPreference` table. All the data in the column will be lost.
...
ALTER COLUMN "favoritedById" SET DATA TYPE TEXT,
